package homework.day04.booking.biz;

import homework.day04.booking.entity.Art;
import homework.day04.booking.entity.Drama;
import homework.day04.booking.entity.Movie;
import homework.day04.booking.entity.Musical;
...
public class ReservationBiz implements IReservationBiz {
    ...
    private Art[] artList;  // Art를 상속하는 하위 클래스들 관리 자료구조 - 배열
    private int index;      // 배열의 저장위치를 가리키기 위함

    //    private List<Art> artList;   // Art를 상속하는 하위 클래스들 관리 자료구조 - 리스트
