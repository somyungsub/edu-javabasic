...
public class Main {
    public static void main(String[] args)  {
        ...
        System.out.println(obj);            // 모든객체의 변수를 그냥 쓰면 toString()이 내부적으로 호출됩니다.
        ...
        System.out.println("s1은 toString을 명시 하지 않았지만, 위에 s1과 s2는 동일한 값이 나옵니다. 이유가 무엇일까요??");
        ...
        // 결과 예상해보기 현재 Professor클래스의 toString은 주석처리되어 있습니다.
        // Professor 클래스를 살펴보시고 과연 어떤 값이 출력이 될지 생각 해봅시다!
